...
def project():
    projects = [
        {
            'title': 'Robust biometric attendance system via content-based feature extraction and classification of acknowledged sound',
            'description': 'Biometric attendance systems have simplified tracking but still present challenges, '
                           'such as users not being assured their attendance is recorded. A novel method using '
                           'machine learning addresses this by analyzing thank-you sounds from biometric devices. '
                           'The system applies signal processing techniques like Mel-frequency cepstral coefficients '
                           '(MFCC) and Mel spectrograms to distinguish genuine acknowledgments from noise. This '
                           'scalable and versatile solution integrates seamlessly with existing systems, automating '
                           'attendance tracking while providing users with confirmation that their attendance has '
                           'been recorded.',
            'link': None,  # This project has no link
            'icon': 'fas fa-user-check',  # Font Awesome icon class
        ...
        },
        {
            ...
            'link': 'https://github.com/Aditya-00001/Instagram-Automation',  # This project has a link
            'icon': 'fab fa-instagram',  # Font Awesome icon class
        ...
        },
        {
            ...
            'description': 'The Text to Morse Code Converter is a command-line interface (CLI) application designed to '
                           'facilitate the conversion of text into Morse code and vice versa. This project aims to '
                           'provide users with an intuitive tool for encoding and decoding messages using the universal '
                           'language of Morse code.',
            'link': 'https://github.com/Aditya-00001/python-professional/blob/main/textToMorse.py',
            # This project has a link
