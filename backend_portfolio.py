    ...
    projects = [
        {
            ...
            'description': 'Biometric attendance systems have simplified tracking but still present challenges, such as users not being assured their attendance is recorded. A novel method using machine learning addresses this by analyzing thank-you sounds from biometric devices. The system applies signal processing techniques like Mel-frequency cepstral coefficients (MFCC) and Mel spectrograms to distinguish genuine acknowledgments from noise. This scalable and versatile solution integrates seamlessly with existing systems, automating attendance tracking while providing users with confirmation that their attendance has been recorded.',
